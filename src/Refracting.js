...
export default class RefractingSphere {
  constructor({
    ...
    this.size = size;
    this.zoom = zoomDistance || { x: null, y: null, z: null };
    ...
    this.mesh = mesh;
    this.mesh.material = this.refractMaterial;
